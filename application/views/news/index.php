...
foreach ($breaking_news as $breaking) {
	echo '<li><i class="fa fa-angle-double-right"></i>
										<a href="' . site_url('news/news_details/') . $breaking['id'] . '">' . $breaking['title'] . '</a>
									  </li>';
}
?>
					</ul>
			...
			<div class="section">
				...
				<?php if (count($national_news) > 0) {?>
					<div class="row">
														...
														<div class="col-md-6">
															<div class="post medium-post">
																...
																<div class="post-content">
																	...
																	<h2 class="entry-title">
																		<?php echo '<a href="' . site_url('news/news_details/') . $national['id'] . '">' . $national['title'] . '</a>'; ?>
																	</h2>
																</div>
															</div><!--/post-->
														</div>
						...
						<?php if (isset($national_feature_news)) {?>
										...
										<ul class="post-list">
											<li>
												<div class="post small-post">
													<div class="entry-header">
														<div class="entry-thumbnail">
															<img class="img-responsive" src="<?php echo base_url(); ?>assets/img/<?php echo $national_feature_news['image'] ?>" alt="" />
														</div>
													</div>
													<div class="post-content">
														<div class="video-catagory"><a href="#">National</a></div>
														<h2 class="entry-title">
															<?php echo '<a href="' . site_url('news/news_details/') . $national_feature_news['id'] . '">' . $national_feature_news['title'] . '</a>'; ?>
														</h2>
													</div>
												</div><!--/post-->
											</li>
				...
				<?php if (count($international_news) > 0) {?>
					<div class="row">
														...
														<div class="col-md-6">
															<div class="post medium-post">
																...
																<div class="post-content">
																	...
																	<h2 class="entry-title">
																		<?php echo '<a href="' . site_url('news/news_details/') . $international['id'] . '">' . $international['title'] . '</a>'; ?>
																	</h2>
																</div>
															</div><!--/post-->
														</div>
						...
						<?php if (isset($international_feature_news)) {?>
							<div class="col-md-3 col-sm-4">
								<div id="sitebar">
									<div class="widget">
										<ul class="post-list">
											<li>
												<div class="post small-post">
													<div class="entry-header">
														<div class="entry-thumbnail">
															<img class="img-responsive" src="<?php echo base_url(); ?>assets/img/<?php echo $international_feature_news['image'] ?>" alt="" />
														</div>
													</div>
													<div class="post-content">
														<div class="video-catagory"><a href="#">International</a></div>
														<h2 class="entry-title">
															<?php echo '<a href="' . site_url('news/news_details/') . $international_feature_news['id'] . '">' . $international_feature_news['title'] . '</a>'; ?>
														</h2>
													</div>
												</div><!--/post-->
											</li>
				...
				<?php if (count($sports_news) > 0) {?>
					<div class="row">
														...
														<div class="col-md-6">
															<div class="post medium-post">
																...
																<div class="post-content">
																	...
																	<h2 class="entry-title">
																		<?php echo '<a href="' . site_url('news/news_details/') . $sports['id'] . '">' . $sports['title'] . '</a>'; ?>
																	</h2>
																</div>
															</div><!--/post-->
														</div>
						...
						<?php if (isset($sports_feature_news)) {?>
							<div class="col-md-3 col-sm-4">
								<div id="sitebar">
									<div class="widget">
										<ul class="post-list">
											<li>
												<div class="post small-post">
													<div class="entry-header">
														<div class="entry-thumbnail">
															<img class="img-responsive" src="<?php echo base_url(); ?>assets/img/<?php echo $sports_feature_news['image'] ?>" alt="" />
														</div>
													</div>
													<div class="post-content">
														<div class="video-catagory"><a href="#">Sports</a></div>
														<h2 class="entry-title">
															<?php echo '<a href="' . site_url('news/news_details/') . $sports_feature_news['id'] . '">' . $sports_feature_news['title'] . '</a>'; ?>
														</h2>
													</div>
												</div><!--/post-->
											</li>
